module github.com/usc-platform/usc-social-xxx-app/SERVICES/service-04-usc-blockchain-core/block-chain-cosmos
...
// cosmossdk.io/server/v2 will be added once a valid version is available in this environment
